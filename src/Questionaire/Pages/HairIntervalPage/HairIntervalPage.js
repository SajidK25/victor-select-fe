...
import { getPrices, MAX_AMOUNT } from "../../../_constants/hairSelections";
...
import { HairIntervalDisplay } from "./HairIntervalDisplay";

const validateHairInterval = values => {
  const errors = {};
  ...
  return (
    ...
    >
      <Field
        ...
        options={options}
        displayComponent={HairIntervalDisplay}
        name={fieldName}
        type="div"
      />
...
export { HairIntervalPage, validateHairInterval };
