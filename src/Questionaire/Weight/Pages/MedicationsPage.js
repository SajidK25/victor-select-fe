...
const options = [
  {
    ...
    explainText: "Please list medications, duration, any weight loss, any side effects and if you're still taking.",
  },
  { id: "no", label: "No" },
];
...
const questionText = "Have you taken weight loss medications (OTC and prescription)?";
const additionalText = "";

const MedicationsPage = (props) => {
  return <RadioPage name="medications.answer" options={options} questionText={questionText} additionalText={additionalText} {...props} />;
};
