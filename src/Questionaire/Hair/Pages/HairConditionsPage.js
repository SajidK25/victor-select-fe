...
const options = [
  {
    name: "conditions.noTreatment",
    label:
      "Any condition where you have been advised not to take medications related to hair loss",
    explain: "conditions.noTreatmentExplain",
...
const validateHairConditions = values => {
  ...
  if (c.noTreatment && !c.noTreatment) {
    errors.conditions = { noTreatmentExplain: "Please provide details." };
  }
...
const HairConditionsPage = props => {
  return (
    <CheckboxPage
      options={options}
...
export { HairConditionsPage, validateHairConditions };
