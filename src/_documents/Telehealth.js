  ...
  return (
    <>
      <Typography paragraph>
        ...
        Statement of Privacy applies to our Practice’s Web site and governs data
        collection and usage. By using this website, you consent to the data
      ...
      <Typography paragraph>
        This Practice collects personally identifiable information, such as your
        e-mail address, name, home or work address or telephone number. This
        Practice also collects anonymous demographic information, which is not
      ...
      <Typography paragraph>
        ...
        is automatically collected by this website. This information can
        include: your IP address, browser type, domain names, access times and
        referring Web site addresses. This information is used for the operation
        of the service, to maintain quality of the service, and to provide
        general statistics regarding use of this Web site.
      </Typography>
      <Typography paragraph>
      ...
      <Typography paragraph>
        ...
        sites you choose to link to from the website so that you can understand
        how those Web sites collect, use and share your information. This
        Practice is not responsible for the privacy statements or other content
        on any other Web sites.
      </Typography>
      <Typography paragraph>&nbsp;</Typography>
      <h3>
      ...
      <Typography paragraph>
        This Practice collects and uses your personal information to operate the
        Web site and deliver the services you have requested. This Practice also
        uses your personally identifiable information to inform you of other
        products or services available from this Practice and its affiliates.
        This Practice may also contact you via surveys to conduct research about
        your opinion of current services or of potential new services that may
        be offered.
      </Typography>
      <Typography paragraph>
        This Practice does not sell, rent or lease its customer lists to third
        parties. This Practice may share data with trusted partners to help us
      ...
      <Typography paragraph>
        This Practice does not use or disclose sensitive personal information,
        such as race, religion, or political affiliations, without your explicit
        consent.
      </Typography>
      <Typography paragraph>
        This Practice will disclose your personal information, without notice,
      ...
      <Typography paragraph>
        ...
        reflect company and customer feedback. We encourage you to periodically
        review this Statement to be informed of how this Practice is protecting
        your information.
      </Typography>
      <Typography paragraph>&nbsp;</Typography>
      <h3>
